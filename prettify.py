...
#--------------------------------------------------------"Pretty Comments", coded with love by Github.com/HamidValad---------------------------------------------------------#*|
...
parser.add_argument('--credit', '-c', help='Add optional credit in empty lines', type=str, default='--"Pretty Comments", coded with love by Github.com/HamidValad--')        #*|
#--------------------------------------------------------"Pretty Comments", coded with love by Github.com/HamidValad---------------------------------------------------------#*|
if len(sys.argv) < 2:                                                                                                                                                        #*|Check if any argument sent in command line
    filename = input('Enter your file name: \n')                                                                                                                             #*|Ask user to input file name if not sent as argument
    n = 7                                                                                                                                                                    #*|
    Credit = '--"Pretty Comments", coded with love by Github.com/HamidValad--'                                                                                               #*|
...
#--------------------------------------------------------"Pretty Commemts", coded with love by Github.com/HamidValad---------------------------------------------------------#*|
l = len(Credit)                                                                                                                                                              #*|
res = []                                                                                                                                                                     #*|
...
#--------------------------------------------------------"Pretty Comments", coded with love by Github.com/HamidValad---------------------------------------------------------#*|
Skip = False                                                                                                                                                                 #*|defining variable for handling multiline string             
if Type:                                                                                                                                                                     #*|
    for line in lines:                                                                                                                                                       #*|
        comment = ''                                                                                                                                                         #*|
        ...
        if Skip:                                                                                                                                                             #*|skip the line if it is in multiline strings
            res.append(line)                                                                                                                                                 #*|
        ...
        elif ('"""' in line) or ("'''" in line):                                                                                                                             #*|Handle Multiline strings
            res.append(line)                                                                                                                                                 #*|
            Skip = not Skip                                                                                                                                                  #*|change the value of Skip for nexet thriple cotation
        elif line.endswith('\\\n') or line.startswith(chr(35)) or ('"""' in line) or ("'''" in line):                                                                        #*|Handle comments and skipped new lines
            res.append(line)                                                                                                                                                 #*|
